...
parser.add_argument('--data_dir', default=r'/content/drive/My Drive/transolver/mlcfd_data/training_data')
parser.add_argument('--save_dir', default=r'/content/drive/My Drive/transolver/mlcfd_data/preprocessed_data')
