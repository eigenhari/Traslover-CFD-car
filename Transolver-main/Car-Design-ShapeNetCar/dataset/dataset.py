...
if __name__ == '__main__':
    ...
    root ='/content/drive/My Drive/transolver/mlcfd_data/training_data'
    save_path = '/content/drive/My Drive/transolver/mlcfd_data/preprocessed_data/pram0' + file_name
